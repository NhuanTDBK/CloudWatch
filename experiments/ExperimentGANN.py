...
if __name__ == '__main__':
    ...
    dataFeeder = TrafficFeeder(datasource=dat,n_input=n_input,period=24*60,n_periodic=n_periodic)
    X_train,y_train = dataFeeder.fetch_traffic_training(n_input,n_periodic,(6,20))
    X_test,y_test = dataFeeder.fetch_traffic_test(n_input,n_periodic,(21,23))
